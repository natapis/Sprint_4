...
public class QuestionsAboutImportant {
    ...
    public QuestionsAboutImportant(int numberQuestion, String expected){
    ...
    public void checkTextInDropdownList(){
        ...
        mainPage.open();
        mainPage.clickToQuestion(numberQuestion);
        mainPage.scrollToAnswer(numberQuestion);
        String actual = mainPage.getAnswerToNumber(numberQuestion);
